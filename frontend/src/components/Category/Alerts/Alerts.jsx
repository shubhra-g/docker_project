...
export const Success = ({message}) => {
    ...
    <div className="bg-green-100 rounded-lg py-5 px-6 mb-3 text-base text-green-700 inline-flex items-center w-full" role="alert">
        ...
        <path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm114.9 161.1c4.7-4.7 12.3-4.7 17 0l39.6 39.6c4.7 4.7 4.7 12.3 0 17L312 368l-65.6 65.1c-4.7 4.7-12.3 4.7-17 0L166.4 338c-4.7-4.7-4.7-12.3 0-17l39.6-39.6c4.7-4.7 12.3-4.7 17 0l65 65.7 65.1-65.6z" />
        </svg>
        {message}
    </div>
    </div>
...
export const Warning = ({message}) => {
  return (
<div className="alert alert-error shadow-lg text-md font-bold">
  <div>
