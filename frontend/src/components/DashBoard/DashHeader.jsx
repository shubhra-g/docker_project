    ...
    <div className="container-fluid w-full flex flex-wrap items-center justify-between px-6">
      ...
      <div className="collapse navbar-collapse flex-grow items-center" id="navbarSupportedContent1">
        ...
        <ul className="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
          ...
          <li className="nav-item p-2">
            <a className="nav-link text-white opacity-60 hover:opacity-80 focus:opacity-80 p-0" href="#">Team</a>
          </li>
          <li className="nav-item p-2">
      ...
      <div className="flex items-center relative">
        ...
        <div className="dropdown relative">
          <a className="text-white opacity-60 hover:opacity-80 focus:opacity-80 mr-4 dropdown-toggle hidden-arrow flex items-center" href="#" id="dropdownMenuButton1" role="button" data-bs-toggle="dropdown" aria-expanded="false">
